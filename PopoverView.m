...
#define kGradientBottomColor [UIColor colorWithWhite:30.0/255.0 alpha:kBoxAlpha]

//top color white value in gradient bg
#define kGradientTopColor [UIColor colorWithWhite:30.0/255.0 alpha:kBoxAlpha]
